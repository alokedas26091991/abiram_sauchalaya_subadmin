...
<?= $this->Html->charset() ?>
        ...
        <link href="../../admin_template/images/logo/logo-main.png" type="image/x-icon" rel="icon"/><link href="../../admin_template/images/logo/logo-main.png" type="image/x-icon" rel="shortcut icon"/> 
