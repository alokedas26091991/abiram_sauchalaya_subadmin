...
define('ACCESS_GENERAL',0);
define('ACCESS_VENDOR',1);
define('ACCESS_ADMIN',2);
define('ACCESS_API',3);
define('TAX_PERCENTAGE',18);
define('DISCOUNT1',10);
define('DISCOUNT2',5);
define("NO_OF_HARDER_PERCENTAGE", 30);
define("NO_OF_MEDIUM_PERCENTAGE", 30);
define("NO_OF_EASY_PERCENTAGE", 40);

define("RAZORPAY_KEY_ID", "rzp_test_GfN01O42IGcAlQ");
define("RAZORPAY_KEY_SECRET", "eyhXe8MZLFWzTuGgMAYX4XoO");
/*
